...
(function () {
  ...
  const LOCALES = {
    ...
    en: {
      ...
      'game.js.fishing_success':    '🎣 Fish caught! +{xp} XP',
      'game.js.farm_select_plants':  'Select your plants',
      ...
      'game.js.equipped_note':      'Equipped — selling {n} extra copies',
    ...
    'pt-BR': {
      ...
      'game.js.fishing_success':    '🎣 Peixe capturado! +{xp} XP',
      'game.js.farm_select_plants':  'Selecione suas plantas',
      ...
      'game.js.equipped_note':      'Equipado — vendendo {n} cópias extras',
